...
function NavBar() {
  ...
  return (
    <div className={styles.principalContainer}>
      ...
      <Link
        className={styles.linkIconMovil}
        to={
      ...
      <button
        className={`${styles.langButton} ${styles.langButtonMovil}`}
      ...
      >
        ...
        >
          <div className={styles.socialwebContainer628}>
            <svg
              className={` ${styles.navBarIcon628}`}
              fill="#FFFFFF"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 48 48"
              width="48px"
            ...
            <h3 className={styles.h3movil328}>GitHub</h3>
          </div>
        </Link>
        <Link
          className={styles.linkMovil628}
        ...
        >
          <div className={styles.socialwebContainer628}>
            ...
            <h3 className={styles.h3movil328}>LinkedIn</h3>
          </div>
        </Link>

        {/* Agrega el resto de tus enlaces aquí... */}
      </div>
